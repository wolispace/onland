...
const assets = {
  ...
  // when replacing elements in an html or svg
  // the last three are for svg styles
  replacables: ['x', 'y', 'w', 'h', 'id', 'type', 'variant', 'content', 'left', 'top', 'width'],
  /**
   * 
   * @param {string} type 
   * @param {string} id 
  ...
  /**
   * Replace all replacables in the html with the values from this object
  ...
  items: {
    tree: {
      basic: {
        ...
        content: `<svg viewBox="0 0 104 121" style="left:%left%px; top:%top%px; width:%width%px;">
    ...
    rock: {
      basic: {
        ...
        content: `<svg viewBox="0 0 97 64" style="left:%left%px; top:%top%px; width:%width%px;">
    ...
    diamond: {
      basic: {
        ...
        content: `<svg viewBox="0 0 79 68" style="left:%left%px; top:%top%px; width:%width%px;">
    ...
    arch: {
      basic: {
        ...
        content: `<svg viewBox="0 0 200 200" style="left:%left%px; top:%top%px; width:%width%px;">
    ...
    river: {
      basic: {
        ...
        content: `<svg viewBox="0 0 139 200" style="left:%left%px; top:%top%px; width:%width%px;">
