const items = {
    ...
    // x,y is part of the item
    // the image is offset top, left and the collisions are offset from the items x,y
    makeDiamond(id = 'unknown', x = 0, y = 0, autoShow = false) {
        let params = {
            id: id, 
            x: x,
            y: y,
        ...
        params.svg = `<svg viewBox="0 0 79 68" ${style}>
